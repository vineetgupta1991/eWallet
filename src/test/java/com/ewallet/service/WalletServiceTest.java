...
public class WalletServiceTest {
    ...
    public void getAccountBalanceForCurrentWallet() throws Exception {
        ...
        when(accountRepoMock.save(any())).thenReturn(account);
    ...
    public void withdrawFromAccount() throws Exception {
        ...
        when(walletRepoMock.findById(anyInt())).thenReturn(java.util.Optional.ofNullable(w));
        when(accountRepoMock.save(any())).thenReturn(account);
        assertTrue(90-walletService.withdrawFromAccount(12, 100, 10f, TransactionType.WITHDRAW).getBalance()<0.01);
    }
    ...
    public void withdrawFromAccount_InsufficientBalance() throws InsufficientBalanceInWalletException, Exception {
        ...
        when(walletRepoMock.findById(anyInt())).thenReturn(java.util.Optional.ofNullable(w));
        when(accountRepoMock.save(any())).thenReturn(account);
        assertTrue(90-walletService.withdrawFromAccount(12, 100, 200f, TransactionType.WITHDRAW).getBalance()<0.01);
    }
    ...
    public void depositToAccount() throws Exception{
        ...
        when(walletRepoMock.findById(anyInt())).thenReturn(java.util.Optional.ofNullable(w));
        when(accountRepoMock.save(any())).thenReturn(account);
        assertTrue(110-walletService.depositToAccount(13, 100, 10f, TransactionType.DEPOSIT).getBalance()<0.01);
    ...
    public void getStatement() throws Exception{
        ...
        when(accountRepoMock.save(any())).thenReturn(account);
        walletService.withdrawFromAccount(20, 100, 10f, TransactionType.WITHDRAW);
